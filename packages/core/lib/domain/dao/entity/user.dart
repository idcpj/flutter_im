...
class User implements Table {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'user_platform': userPlatform.value,
  ...
  User fromMap(Map<String, dynamic> map) {
    return User(
      ...
      userStatus: UserStatusType.values.firstWhere((e) => e.value == map['user_status']),
      userSex: UserSexType.values.firstWhere((e) => e.value == map['user_sex']),
      ...
      userPlatform: PlatformType.values.firstWhere((e) => e.value == map['user_platform']),
